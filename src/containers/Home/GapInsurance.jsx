  ...
  render() {
    return (<section className="section bg-dark-blue" id="gap-insurance">
      <div className="gap-tabs">
        <div className="container">
          <ul className="nav nav-pills" role="tablist">
            ...
            <li className="nav-item">
              <a className="nav-link" href="#light-casco" role="tab" data-toggle="tab">Accident & Health</a>
            </li>
            <li className="nav-item">
              <a className="nav-link" href="#full-casco" role="tab" data-toggle="tab">Travel</a>
            </li>
            <li className="nav-item">
              <a className="nav-link" href="#driver-accident" role="tab" data-toggle="tab">Job Loss</a>
            </li>
          </ul>
        </div>
      </div>
      <div className="tab-content">
        ...
        <div role="tabpanel" className="tab-pane" id="light-casco">
        <div className="container text-white">
            <div className="row">
              <div className="left-block col-12 col-md-6">
                <h3 className="subtitle">
        ...
        <div role="tabpanel" className="tab-pane" id="full-casco">
        <div className="container text-white">
            <div className="row">
              <div className="left-block col-12 col-md-6">
                <h3 className="subtitle">
        ...
        <div role="tabpanel" className="tab-pane" id="driver-accident">
        <div className="container text-white">
            <div className="row">
              <div className="left-block col-12 col-md-6">
                <h3 className="subtitle">
