  ...
  render () {
    return <div className="text-container">
      ...
      <p className="text text-grey">
        Qover SA/NV (in short Qover), with registered office at rue Eugène Toussaint 54, box 1 – 1090 Brussels, RPR
      ...
      <p className="text text-grey">
        The Financial Services Market Authority (in short: FSMA) is responsible for supervising the financial markets and
      ...
      <p className="text text-grey">
        All pre-contractual relations with our consumers are based upon the Belgian Insurance Law of 4 April 2014 and
      ...
      <p className="text text-grey">
        The information and other data published and made accessible through this site are purely informative. For this
      ...
      <p className="text text-grey">
        The general terms & conditions of the insurance products offered by Qover can be consulted online at the
        product configuration page of each product.
      </p>
      <p className="text text-grey">
        Qover has a policy on conflicts of interest and a remuneration policy, which can be consulted online on our
        Conflict of Interest page.
      </p>
      <p className="text text-grey">
        You can communicate with us in Dutch, French or English, by the following means:  <br/>
        •&nbsp;in writing: our address is rue des Palais 44 – 1030 Brussels <br/>
        •&nbsp;by phone: our general phone number is +32 2 588 25 50  <br/>
        •&nbsp;by e-mail: our general e-mail address is contact@qover.be <br/>
        •&nbsp;via the contact form on our website <br/>
      </p>
    </div>;
  }
}
