      ...
      <div className="container text-white">
        <div className="row">
          <div className="col-6">
            ...
            <h4 className="title" style={{marginBottom: 20 + 'px'}}>
            ...
            <div>
              <a className="btn button btn-turquoise" href="#">More info about the GAP</a>
              <a className="link text-white" href="#">Become a partner<i className="fa fa-angle-right" aria-hidden="true"></i></a>
            </div>
          </div>
          <div className="col-6">
