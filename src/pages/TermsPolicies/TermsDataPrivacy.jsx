  ...
  render () {
    return <div className="text-container">
      ...
      <div className="item">
        ...
        <ul>
          <li className="text text-grey">
            information provided to us directly (e.g. to our claims handlers), whether by letter, email or otherwise;
          </li>
          <li className="text text-grey">
            information from a third party (e.g. a broker, lawyer or medical expert) authorised to provide it to us;
          </li>
          <li className="text text-grey">
            information received from a third party (e.g. a lawyer or external claims handler appointed by us in relation
            to a claim);
          </li>
          <li className="text text-grey">
            information provided in correspondence with us, or a record of it.
          </li>
        </ul>
      </div>
      ...
      <div className="item">
        ...
        <p className="text text-grey">
          The Personal Information that we collect from you is stored on highlight secured server of AWS (Amazon Web
        ...
        <p className="text text-grey">
          We limit access to Personal Information to those who we reasonably believe need to use that information in
          order to carry out their jobs.
        </p>
        <p className="text text-grey">
          We have physical, electronic, and procedural safeguards that comply with our legal obligations to protect
      ...
      <div className="item">
        ...
        <ul>
          <li className="text text-grey">
            Underwriting: for the purposes of underwriting by us, our associated companies or co-insurers
          </li>
          <li className="text text-grey">
            Claims handling: for the purposes of claims handling by us and by our associated companies, co-insurers,
          ...
          <li className="text text-grey">
            Fraud and crime prevention: in connection with compliance with law, regulation and any rules or codes.
          </li>
        </ul>
        <p className="text text-grey">
          Where you provide us with Personal Information that may be regarded as “sensitive personal data” you agree
      ...
      <div className="item">
        <h6 className="subtitle text-turquoise">
          Information that you provide about other parties
        </h6>
        <p className="text text-grey">
          Where you submit Personal Information to us about other parties, we rely on you to have first obtained
        ...
        <p className="text text-grey">
          By submitting such information to us you confirm that you have all necessary permissions and consents to do so.
        </p>
      </div>
      ...
      <div className="item">
        ...
        <p className="text text-grey">
          For the purposes set out above, we may share the information that you submit with the following third parties:
        </p>
        <ul>
          <li className="text text-grey">
            any member of Qover
          ...
          <li className="text text-grey">
            co-insurers, relevant insurance intermediaries and business introducers;
          </li>
          <li className="text text-grey">
            third parties instructed and/or advising us for the purposes of claims handling, pricing analysis, fraud
            prevention or statistics;
          </li>
          <li className="text text-grey">
            reinsurer(s) and reinsurance brokers;
          </li>
          <li className="text text-grey">
            law enforcement or regulatory bodies in connection with compliance with any laws, regulation, rules or
            codes.
          </li>
        </ul>
        <p className="text text-grey">
        ...
        <ul>
          <li className="text text-grey">
            if we, or substantially all of our assets or a part of our business, are or may be acquired by a third party, in
            which case Personal Information held by us about our customers may be one of the transferred assets;
            and
          </li>
          <li className="text text-grey">
            to protect the rights, property, or safety of us, our customers, or others (e.g. exchanging information with
      ...
      <div className="item">
        ...
        <p className="text text-grey">
          This Privacy Policy is effective as of 18/01/2017 and will remain in effect except with respect to any changes in
